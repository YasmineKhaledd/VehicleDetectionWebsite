...
<body class="text-center">
    ...
    <div class="paragraph">
        ...
        <div class="col-md-4">
                ...
                <div class="card cardView h-100" id="speeding">
                    <img src="speed.jpg" class="card-img-top rounded-circle">
                    <div class="card-body">
...
<div class="card cardView h-100" id="Color">
    <img src="color1.jpg" class="card-img-top rounded-circle">
    <div class="card-body">
...
<div class="col-md-4">
                <div class="card cardView h-100" id="Damage">
                    <img src="damage.jpg" class="card-img-top rounded-circle">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="Type">
                    <img src="type.jpg" class="card-img-top rounded-circle">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="RedLight">
                    <img src="red.jpg" class="card-img-top rounded-circle">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="DUI">
                    <img src="drugs.PNG" class="card-img-top rounded-circle"> 
                    <div class="card-body">
        ...
        <div class="row p-2 text-center">
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="Mobile">
                    <img src="phone.jpg" class="card-img-top rounded-circle">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="belt">
                    <img src="belty.png" class="card-img-top rounded-circle">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="Illegal">
                    <img src="overtaking.jpg" class="card-img-top rounded-circle">
                    <div class="card-body">
        ...
        <div class="row p-2 text-center">
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="Liscence">
                    <img src="liscence.png" class="card-img-top rounded-circle">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card cardView h-100" id="parking">
                    <img src="parking.PNG" class="card-img-top rounded-circle">
                    <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card cardView h-100" id="Overloading">
                <img src="over.jpg" class="card-img-top rounded-circle">
                <div class="card-body">
