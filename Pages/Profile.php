...
<div class="row justify-content-center">
  ...
  <div class="mb-2 mb-xl-3 display-28  text-center" style="margin-left:80px">
    <span class="display-26 text-danger me-2 font-weight-600 fw-bold">NationalId:  </span> 
  ...
  <div class="mb-2 mb-xl-3 display-28  text-center"style="margin-left:20px">
    <span class="display-26 text-danger me-2 font-weight-600 fw-bold">PlateNumber:</span> 
