...
<main>
      ...
      <form action="Detection-Page.php" method="post" enctype="multipart/form-data">
  ...
  <div style="margin-left:500px">
    ...
    <input type="file" class="form-control" id="videoFile" name="videoFile" style="width: 500px;"><br>
  </div>
